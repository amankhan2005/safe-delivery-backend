...
router.post('/send-phone-otp',    sendPhoneOTPHandler);   // NEW: Twilio SMS
router.post('/verify-phone-otp',  verifyPhoneOTP);        // CHANGED: accepts {phone, otp}
...
router.post('/rider-send-phone-otp',     riderSendPhoneOTP);   // NEW: Twilio SMS
router.post('/rider-verify-phone-otp',   riderVerifyPhoneOTP); // CHANGED: accepts {phone, otp}
